...
unset(
    $action_row_copy['action_id'], $action_row_copy['action_ids'], $action_row_copy['action_ts'], $action_row_copy['created'], $action_row_copy['updated'],
    $previous_action_row_copy['action_id'], $previous_action_row_copy['action_ids'], $previous_action_row_copy['action_ts'], $previous_action_row_copy['created'], $previous_action_row_copy['updated']
);
